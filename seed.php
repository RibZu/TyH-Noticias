<?php
// Script para cargar usuarios y noticias de prueba
...
class SeedCompleto {
    ...
    private function crearUsuarios() {
        ...
        // Usuario 3: Editor y Validador (Dual)
        $id = $this->usuarioModel->registrar(
            'Carlos Dual',
            'dual@test.com',
            'dual123',
        ...
        // Usuario 4: Administrador (Editor + Validador)
        $id = $this->usuarioModel->registrar(
            'Admin General',
            'admin@tyh.com',
            'admin123',
    ...
    private function crearNoticias($usuarios) {
        ...
        // Editor - Lista para Validación sin imagen
        ...
        // Editor - Lista para Validación con imagen
        $id = $this->crearNoticia(
        ...
        // Editor - Para Corrección sin imagen
        $id = $this->crearNoticia(
        ...
        // Validador - Lista para Validación con imagen
        $id = $this->crearNoticia(
        ...
        // Validador - Publicada sin imagen
        $id = $this->crearNoticia(
        ...
        // Dual - Lista para Validación sin imagen
        $id = $this->crearNoticia(
        ...
        // Admin - Lista para Validación con imagen
        $id = $this->crearNoticia(
    ...
    private function crearNoticia($titulo, $descripcion, $autor_id, $estado, $imagen = null, $fecha_publicacion = null) {
        // Verificar que la descripción tenga al menos 50 caracteres
    ...
    private function mostrarResumen() {
        ...
        // Contar noticias con/sin imagen
        $query = "SELECT 
